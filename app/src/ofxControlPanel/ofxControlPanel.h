...
class ofxControlPanel: public guiBaseObject{
	...
	public:
		...
		guiType2DSliderPixelChooser * addSlider2DPixelChooser(string sliderName, string xmlName, float valueX, float valueY, float minX, float maxX, float minY, float maxY, bool isInt);
